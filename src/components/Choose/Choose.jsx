        ...
        <section className="choose">
            <div className="container container-flex">
                <div className="content">
                    ...
                    <p className="p18b">When an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
                    ...
                    <div className="choose__block">
                        <div className="choose__groups">
                            ...
                            <div className="choose__group">
                                ...
                                <p className='p16b'>It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages.</p>
                            </div>
